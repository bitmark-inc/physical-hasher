...
#define MEDIASUBTYPE_RGB8  0x7a, 0xeb, 0x36, 0xe4,      \
		0x4f, 0x52,                             \
		0xce, 0x11,                             \
		0x9f, 0x53,                             \
...
#define MEDIASUBTYPE_RGB32 0x7e, 0xeb, 0x36, 0xe4,      \
		0x4f, 0x52,                             \
		0xce, 0x11,                             \
		0x9f, 0x53,                             \
		0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70
...
#define MEDIASUBTYPE_YUY2 0x59, 0x55, 0x59, 0x32,       \
		0x00, 0x00,                             \
		0x10, 0x00,                             \
		0x80, 0x00,                             \
...
const uint8_t esUVCUSBSSConfigDscr[] = {
...
#if 1
	MEDIASUBTYPE_YUY2,
	0x10,                               // Number of bits per pixel: 32
...
#endif
	0x01,                               // Optimum Frame Index for this stream
	...
	0x00, 0x81, 0x7C, 0x00,             // Maximum video or still frame size in bytes(Deprecated): 1920 x 1080 x 4
	...
	0x00, 0x09,                         // Width in pixel: 2304
	0x10, 0x05,                         // Height in pixel: 1296
...
const uint8_t glProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
...
const uint8_t gl1080pProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
	0x00, 0x00,                         // bmHint: No fixed parameters
	0x01,                               // Use 1st Video format index
	0x01,                               // Use 1st Video frame index
...
const uint8_t glVga60ProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
	0x00, 0x00,                         // bmHint: No fixed parameters
	0x01,                               // Use 1st Video format index
...
const uint8_t gl720pProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
	0x00, 0x00,                         // bmHint: No fixed parameters
	0x01,                               // Use 1st Video format index
...
const uint8_t gl5MpProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
	0x00, 0x00,                         // bmHint: No fixed parameters
	0x01,                               // Use 1st Video format index
	...
	0x00, 0x20, 0x5b, 0x00,             // Max video frame size in bytes = 2304 x 1296 x 2
	0x00, 0x90, 0x00, 0x00              // No. of bytes device can rx in single payload: 36KB
};
// UVC Probe Control Setting - VGA @30fps (High Speed)
const uint8_t glVga30ProbeCtrl[ES_UVC_MAX_PROBE_SETTING] = {
	0x00, 0x00,                         // bmHint: No fixed parameters
	0x01,                               // Use 1st Video format index
...
const uint8_t glStillProbeCtrl[ES_UVC_MAX_STILL_PROBE_SETTING] = {
	0x01,                               // Use 1st Video format index
	0x01,                               // Use 1st Video frame index
...
#define USE_N_LANES 4

// Configuration parameters for 5Mp @15FPS for the sensor
const CyU3PMipicsiCfg_t cfgUvc5Mp15NoMclk = {
	//CY_U3P_CSI_DF_YUV422_10,          // dataFormat
	CY_U3P_CSI_DF_RAW12,                // dataFormat
	2,                                  // numDataLanes
	1,                                  // pllPrd
	62,                                 // pllFbd
...
// Configuration parameters for 1080p @30FPS for the sensor
const CyU3PMipicsiCfg_t cfgUvc1080p30NoMclk = {
...
// Configuration parameters for 720p @60FPS for the sensor
const CyU3PMipicsiCfg_t cfgUvc720p60NoMclk = {
	//CY_U3P_CSI_DF_YUV422_10,          // dataFormat
	CY_U3P_CSI_DF_RAW12,                // dataFormat
	2,                                  // numDataLanes
	1,                                  // pllPrd
...
const CyU3PMipicsiCfg_t cfgUvcVgaNoMclk = {
	//CY_U3P_CSI_DF_YUV422_10,          // dataFormat
	CY_U3P_CSI_DF_RAW12,                // dataFormat
	1,                                  // numDataLanes
	0x1,                                // pllPrd
...
//const CyU3PMipicsiCfg_t cfgUvcVga30NoMclk = {
//              CY_U3P_CSI_DF_YUV422_10,      // dataFormat
//              1,                            // numDataLanes
//              0x4,                          // pllPrd
//              0x6F,                         // pllFbd
