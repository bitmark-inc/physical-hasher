...
esUVCUvcApplnInit (void)
{
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_SS_DEVICE_DESCR, NULL, (uint8_t *)esUVCUSB30DeviceDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_HS_DEVICE_DESCR, NULL, (uint8_t *)esUVCUSB20DeviceDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    /* BOS descriptor */
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_SS_BOS_DESCR, NULL, (uint8_t *)esUVCUSBBOSDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_DEVQUAL_DESCR, NULL, (uint8_t *)esUVCUSBDeviceQualDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_SS_CONFIG_DESCR, NULL, (uint8_t *)esUVCUSBSSConfigDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_HS_CONFIG_DESCR, NULL, (uint8_t *)esUVCUSBHSConfigDscr);
    if (status != CY_U3P_SUCCESS)
    {
    ...
    status = CyU3PUsbSetDesc(CY_U3P_USB_SET_FS_CONFIG_DESCR, NULL, (uint8_t *)esUVCUSBFSConfigDscr);
    if (status != CY_U3P_SUCCESS)
    {
